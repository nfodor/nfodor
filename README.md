...
- **SQLTools** – First Windows database administration tool ever created (for any database), built for Sybase SQL Server before Microsoft's acquisition. Oracle and other vendors were still Unix-only with no native Windows tools.
